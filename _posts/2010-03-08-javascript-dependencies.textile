...
Lately I've been thinking about strategies for hosting JavaScript apps.  Dependency management is useful for making deployment as smooth as possible, but what library dependency management options are there right now?  I decided to look at options for "node.js":http://nodejs.org/ and "narwhal":http://narwhaljs.org/.
...
I tested wiki with the current version of node from GitHub (3947270). 
