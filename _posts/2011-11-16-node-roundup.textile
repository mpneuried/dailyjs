...
"Scaffoldit":https://github.com/spiceapps/scaffoldit (npm: _scaffoldit_) by Craig Condon is a scaffolding library that makes it easy to take user input and display data using templates.  Templates can be written using mustache, and it has command-line support through Craig's "celeri":https://github.com/spiceapps/celeri library.
