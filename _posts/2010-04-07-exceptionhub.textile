...
Exception reporting systems can be useful for production environments.  I have a homegrown solution for my commercial web apps, but I can understand why people use services like "Hoptoad":http://hoptoadapp.com/.  ExceptionHub is a little bit more niche because it targets JavaScript.
