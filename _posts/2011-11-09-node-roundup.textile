...
"Cupboard":https://github.com/spiceapps/cupboard (npm: _cupboard_) by Craig Condon is command line tool for managing multiple git/npm projects.  Projects are accessible through the <code>cdb</code> command, and commands can be issued against multiple projects.
