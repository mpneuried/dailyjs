...
If you don't already use Firebug (or similar tools such as Webkit Inspector or Chromebug) for debugging your JavaScript, I strongly suggest adding them to your armory.  I'm not sure I could survive without breakpoints, step-through debugging, an interactive console, and the ability to inspect and manipulate the DOM. :)
