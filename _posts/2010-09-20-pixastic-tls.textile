...
"Force":http://github.com/digitalbazaar/forge is a JavaScript TLS implementation.  TLS (Transport Layer Security) is a cryptographic protocol for secure client/server communication.  Force currently depends on Flash for sockets, but it could remove the dependency in the future.
