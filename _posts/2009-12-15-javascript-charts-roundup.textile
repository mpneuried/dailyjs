...
This is not just restricted to charts, and it doesn't support IE (yet), but I wanted it to include it anyway, as Processing is such as powerful tool (like Raphaël).
