...
We also recently featured "Express":http://dailyjs.com/2009/11/19/express/, which is super-simple and very clean.  It's Sinatra-inspired, and the author has lots of interesting JavaScript on GitHub projects so it's one to keep an eye on (and contribute to!)
