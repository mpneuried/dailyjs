---
layout: post
title: "jQTouch: Create iPhone applications using just HTML, CSS and JavaScript"
author: Ric Roberts
categories: 
- iPhone
- jQuery
...
If you want to dig deeper, there's a "screencast on PeepCode":https://peepcode.com/products/jqtouch, and an "online"::http://building-iphone-apps.labs.oreilly.com/index.html Creative Commons O'Reilly book too.
